...
>------->  Self Advertisement Screen   -tme-out->  Leaderboard Screen  -time-out-1->  Show 1st Place
...
####################################################################################################
        ...
        With/out credits, Last and Next buttons (Page Up and Page Down) switch between
