...
Err_Init:
    If Err.Number = 9 Then
        'Uninitialized array
        MyDebugPrint "PictureFromByteStream() Error1: You must pass a non-empty byte array to this function!"
        End
    Else
        MyDebugPrint "PictureFromByteStream() Error2: " & Err.Number & " - " & Err.Description
        End
    End If
End Function
